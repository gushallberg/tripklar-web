...
export default async function Page({ searchParams }: { searchParams: Record<string, string | undefined> }) {
  const scenario = 'workation';
  const params = {
    scenario,
    city: searchParams.city || 'stockholm',
    date: searchParams.date || '',
    radiusKm: searchParams.radiusKm || '250',
    tags: searchParams.tags || 'wifi,nature',
    limit: '3'
  };
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-4 p-4">
      <h1 className="text-2xl font-semibold">Workations</h1>

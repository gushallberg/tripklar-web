...
// ✅ Viktigt: använd era befintliga typer för att undvika konflikt mellan moduler
import type {
  SuggestParams,
  SuggestItem,
  SuggestResponse,
...
export type { SuggestParams, SuggestItem, SuggestResponse, Itinerary } from '@/lib/types';
